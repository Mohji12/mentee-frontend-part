...
const activities = [
  ...
  {
    title: 'Seek mentorship from a research professor',
    description: 'Connect with a professor whose research interests align with your own to receive guidance and support in navigating the research process.',
    progress: 0,
    type: 'Mid-term',
    status: 'Pending',
    due: '27 Jun 2025',
  ...
  {
    title: 'Undertake independent research project',
    description: 'Apply your knowledge and skills by participating in a research project, even if it\'s a small-scale endeavor. This will build your confidence and expertise.',
    progress: 0,
    type: 'Long-term',
    status: 'Pending',
    due: '27 Jul 2025',
  ...
  {
    title: 'Develop professional networking',
    description: 'Attend research conferences and workshops to meet researchers in your field and build professional contacts. This is invaluable for future opportunities.',
    progress: 10,
    type: 'Long-term',
    status: 'In Progress',
    due: '26 Aug 2025',
  ...
  {
    title: 'Consider additional coursework in statistics or data analysis',
    description: 'To further strengthen your skills, consider taking additional courses that focus on data analysis techniques relevant to your research interests.',
    progress: 0,
    type: 'Long-term',
    status: 'Pending',
    due: '25 Oct 2025',
