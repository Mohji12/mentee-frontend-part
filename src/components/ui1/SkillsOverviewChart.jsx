...
import { BarChart2, LineChart as LineIcon, PieChart as PieIcon, Activity } from "lucide-react";
...
export default function SkillsOverviewChart() {
        ...
        return (
          <ResponsiveContainer width="100%" height={250}>
            <RadarChart outerRadius={90} data={data}>
              ...
              <Radar name="Skills" dataKey="value" stroke="#3182ce" fill="#3182ce" fillOpacity={0.6} />
              <Tooltip />
            </RadarChart>
          </ResponsiveContainer>
        );
